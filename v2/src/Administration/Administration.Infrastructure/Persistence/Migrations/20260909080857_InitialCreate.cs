    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_open_iddict_resources", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    profile_photo_path = table.Column<string>(type: "text", nullable: true),
                    profile_photo_format = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    application_id = table.Column<string>(type: "character varying(100)", nullable: true),
                    concurrency_token = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    application_id = table.Column<string>(type: "character varying(100)", nullable: true),
                    authorization_id = table.Column<string>(type: "character varying(100)", nullable: true),
                    concurrency_token = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    creation_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    login_id = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    properties = table.Column<string>(type: "text", nullable: true),
                    status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    subject = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_open_iddict_sessions", x => x.id);
                    table.ForeignKey(
                        name: "fk_open_iddict_sessions_open_iddict_applications_application_id",
                        column: x => x.application_id,
                        principalTable: "OpenIddictApplications",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_open_iddict_sessions_open_iddict_authorizations_authorization_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    session_id = table.Column<string>(type: "character varying(100)", nullable: true),
                    status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    subject = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_open_iddict_tokens_open_iddict_sessions_session_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_open_iddict_resources_name",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_open_iddict_sessions_application_id",
                table: "OpenIddictSessions",
                column: "application_id");

            migrationBuilder.CreateIndex(
                name: "ix_open_iddict_sessions_authorization_id",
                table: "OpenIddictSessions",
                column: "authorization_id");

            migrationBuilder.CreateIndex(
                name: "ix_open_iddict_sessions_login_id",
                table: "OpenIddictSessions",
                column: "login_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_open_iddict_tokens_session_id",
                table: "OpenIddictTokens",
                column: "session_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_project_memberships_user_id_project_id",
                table: "project_memberships",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_roles_normalized_name_project_id",
                table: "roles",
                columns: new[] { "normalized_name", "project_id" },
                unique: true);
