    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "administration.users.manage", "Create, update, and delete Administration user accounts." },
                    { 2, "administration.roles.manage", "Create roles and assign permissions to them." }
                });
